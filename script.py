...
acceptable_non_NAN_values_fraction = 0.6
...
print("columns needed to be kept from df_previous_application for given acceptable NAN value fraction in a column:")
print(len(df3.columns))
print("columns needed to be dropped from df_previous_application for given acceptable NAN value fraction in a column:")
